...
LOOKUPS_PATH_BASE = Path('model/generate/Lookups')
PREDEFINED_LOOKUPS_PATH = Path(f'{LOOKUPS_PATH_BASE}/Predefined')
INCOME_LOOKUPS_PATH = Path(f'{LOOKUPS_PATH_BASE}/Income')
