...
<div class="registration"
  ...
  <div class="registration__content"
    ...
    <p style="margin-bottom: 0">
      ...
      <br><br>
      Please <a href="{request.host_url}api/confirm_registration?registration_key={registration_key}" style="text-decoration: none; outline: none; color: #066BBB">click here to activate your account</a> and confirm your E-mail.
      <br><br>
    </p>

    <span class="registration__button" style="display: inline-block; text-align: center; background: #066BBB; border-radius: 2px">
      <span style="display: inline-block">
        <a href="{request.host_url}api/confirm_registration?registration_key={registration_key}"
