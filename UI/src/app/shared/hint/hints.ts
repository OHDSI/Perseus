...
export const hints: {[key: string]: Hint} = {
  scanData: {
    ...
    link: 'https://github.com/OHDSI/Perseus/wiki/Connecting-to-native-data#scan-native-databasefiles',
    width: '200px'
  },
  fakeDataGeneration: {
    ...
    link: 'https://github.com/OHDSI/Perseus/wiki/Convert-Fake-data-to-CDM',
    width: '249px'
  },
  createView: {
    ...
    link: 'https://github.com/OHDSI/Perseus/wiki/Link-native-tables-to-CDM-tables#concatenating-native-tables',
    width: '300px'
  },
  createGroup: {
    text: 'Use Ctrl to select multiple fields and then click on Create group.',
    link: 'https://github.com/OHDSI/Perseus/wiki/Link-native-fields-to-CDM-fields#fields-groups',
    width: '237px'
  },
  addCondition: {
    text: 'Set conditional SQL expression\n' +
      'for applying Variation.',
    link: 'https://github.com/OHDSI/Perseus/wiki/Link-native-fields-to-CDM-fields#condition',
    width: '190px',
    position: 'top'
  },
  clone: {
    text: 'Clone button generates a copy\n' +
      'of Target table.',
    link: 'https://github.com/OHDSI/Perseus/wiki/Link-native-fields-to-CDM-fields#clone',
    width: '182px',
    position: 'top'
  },
  sqlTransformation: {
    text: 'Made changes will be shown if you switch from Visual mode to Manual, but not at the opposite.',
    link: 'https://github.com/OHDSI/Perseus/wiki/Link-native-fields-to-CDM-fields#sql-functions',
    width: '230px'
  },
  mySqlScanDataLimit: {
  ...
  eraTable: {
    ...
    width: '220px',
    link: 'https://github.com/OHDSI/Perseus/wiki', // TODO: need to create wiki page for that
  }
}
