...
export default {
  title: 'Perseus/ScanParams',
  component: DatabricksScanParamsComponent,
  // More on argTypes: https://storybook.js.org/docs/angular/api/argtypes
  argTypes: {
    maxWidth: { control: { type: 'range', min: 200, max: 600 }, defaultValue: 430 },
  },
} as Meta;
...
const Template: Story<DatabricksScanParamsComponent> = (args: DatabricksScanParamsComponent) => {
  console.log(args)
  return {
    moduleMetadata: {
      declarations: [
