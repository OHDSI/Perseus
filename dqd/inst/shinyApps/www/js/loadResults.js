function loadResults(results) {
    ...
    var dtResults = $('#dt-results').DataTable({
        ...
        columns: [
            ...
            {
                data: function (d) {
                    return d.cdmFieldName ? d.cdmFieldName : "None";
                }, title: "FIELD", visible: false
            },
            {data: "checkName", title: "CHECK", visible: false},
            {data: "category", title: "CATEGORY"},
            {
                data: function (d) {
                    return d.subcategory ? d.subcategory : "None"
                }, title: "SUBCATEGORY"
            },
            {data: "checkLevel", title: "LEVEL"},
            {
                data: function (d) {
                    if (d.notesValue == null) {
                        return "None";
                    } else {
                        return "Exists";
                    }
            ...
            },
            {
                ...
                }, title: "%&nbsp;RECORDS", type: "num-fmt", className: 'dt-body-right', orderable: true
            }
        ],
        columnDefs: [{
